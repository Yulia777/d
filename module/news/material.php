...
if (!$Row['name']) MessageSend(1, 'Такой страницы не существует.', '/news');
if (!$Row['active'] and $_SESSION['USER_GROUP'] != 2) MessageSend(1, 'Страница ожидает модерации.', '/news');
Head($Row['name']);
?>
<body>
<div class="wrapper">
...
if (!$Row['active']) $Active = '| <a href="/news/control/id/'.$Param['id'].'/command/active" class="lol">Активировать страницу</a>';
if ($_SESSION['USER_GROUP'] == 2) $EDIT = '| <a href="/news/edit/id/'.$Param['id'].'" class="lol">Редактировать стрницу</a> | <a href="/news/control/id/'.$Param['id'].'/command/delete" class="lol">Удалить страницу</a>'.$Active;
