...
mail($Row['email'], 'Восстановление пароля', 'Ссылка для восстановления: http://blog-dip.mcdir.ru/account/restore/code/'.MIX($_SESSION['RESTORE_CONFIRM']), 'From: robot@php.webtm.ru');
...
mail($_POST['email'], 'Регистрация', 'Ссылка для активации: http://blog-dip.mcdir.ru/account/activate/code/'.MIX($_SESSION['REGISTER_CONFIRM']), 'From: robot@php.webtm.ru');
